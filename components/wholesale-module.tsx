                    ...
                    {editingStock?.id === p.id ? (
                      <div className="flex items-center gap-1 mt-1">
                        <Input
                          ...
                          className="w-20 h-7 text-xs border-green-300"
                          autoFocus
                        />
                  ...
                  <div className="space-y-1">
                    ...
                    {clientPayments(c.id).length === 0
                      ...
                      : clientPayments(c.id).slice(0, 5).map(p => (
                        <div key={p.id} className="flex justify-between text-xs bg-white rounded-lg px-3 py-1.5 border border-green-50">
                    ...
                    {clientSales(c.id).length === 0
                      ...
                      : clientSales(c.id).slice(0, 5).map(s => (
                        <div key={s.id} className="flex justify-between text-xs bg-white rounded-lg px-3 py-1.5 border border-green-50">
