  ...
  return (
    <div className="h-screen overflow-hidden bg-white text-foreground flex flex-col">
      <div className="mx-auto w-full h-full max-w-5xl flex flex-col px-6 py-4 sm:px-10 sm:py-5">
        ...
        {/* LOGO SECCIÓN - Ajustado para que sea más chico */}
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-3">
              {staff.admin.map(name => (
                <button
                  ...
                  className="bg-secondary hover:bg-primary hover:text-primary-foreground text-secondary-foreground py-4 rounded-xl transition-all text-xs sm:text-sm font-bold shadow-sm border border-border"
                >
                  {name}
                </button>
              ))}
